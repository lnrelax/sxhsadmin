<template>
    <div class="app-container">
      ...
      <el-table v-loading="loading" :data="orderList" height="480">
        <el-table-column label="项目名称" prop="orderNumber"  align="center" />
        <el-table-column label="价格(RMB)" prop="serviceId" :show-overflow-tooltip="true"  align="center" />
        <el-table-column label="服务时长(分钟)" prop="serviceName" :show-overflow-tooltip="true"  align="center" />
        <el-table-column label="项目描述" prop="serviceMoney"  align="center"/>
