<template>
    <div class="app-container">
      ...
      <el-table v-loading="loading" :data="orderList" height="480">
        <el-table-column label="优惠券金额" prop="orderNumber"  align="center" />
        <el-table-column label="满减" prop="serviceId" :show-overflow-tooltip="true"  align="center" />
        <el-table-column label="优惠券类型" prop="serviceName" :show-overflow-tooltip="true"  align="center" />
