<template>
    <div class="app-container">
      ...
      <el-table v-loading="loading" :data="orderList" height="480">
        <el-table-column label="ID" prop="orderNumber" width="180" align="center" fixed/>
        <el-table-column label="姓名" prop="serviceId" :show-overflow-tooltip="true" width="120" align="center" fixed/>
        <el-table-column label="店铺码" prop="serviceName" :show-overflow-tooltip="true" width="150" align="center"/>
        <el-table-column label="电话" prop="serviceMoney" width="100" align="center"/>
        <el-table-column label="电话" prop="appointTime" width="160" align="center"/>
        <el-table-column label="首单分成比例" prop="orderTime" width="160" align="center"/>
        <el-table-column label="加钟分成比例" prop="orderMoney" width="120" align="center"/>
